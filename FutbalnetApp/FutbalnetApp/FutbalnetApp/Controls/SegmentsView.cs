...
namespace FutbalnetApp.Controls
{
	public class SegmentView : View, IViewContainer<Segment>, IBorderElement
	{
		...
		private static readonly Color _textColorDefaultValue = Device.RuntimePlatform == Device.Android ? Color.Black : Color.Black;
		private static readonly Color _selectedTextColorDefaultValue = Device.RuntimePlatform == Device.Android ? Color.Black : Color.Black;
		...
		public static BindableProperty TextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(SegmentView), _textColorDefaultValue);
		public static BindableProperty SelectedTextColorProperty = BindableProperty.Create(nameof(TextColor), typeof(Color), typeof(SegmentView), _selectedTextColorDefaultValue);
